...
term4_DE = CAPEX_SOEC_values ./ FLH_DE;
term4_FI = CAPEX_SOEC_values ./ FLH_FI;
term4_SE = CAPEX_SOEC_values ./ FLH_SE;
term4_NO = CAPEX_SOEC_values ./ FLH_NO;
...
plot(FLH_DE, avg_DE_LU_H, '-', 'DisplayName', 'DE', 'LineWidth', 2, 'Color', 'g');
...
plot(FLH_DE, avg_DE_LU_L, '--', 'DisplayName', 'DE', 'LineWidth', 2, 'Color', 'g');
